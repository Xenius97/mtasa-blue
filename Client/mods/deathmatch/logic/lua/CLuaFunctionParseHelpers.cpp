...
IMPLEMENT_ENUM_CLASS_BEGIN(WeaponProperty)
ADD_ENUM(WeaponProperty::WEAPON_WEAPON_RANGE, "weapon_range")
...
ADD_ENUM(WeaponProperty::WEAPON_ANIM_LOOP_RELEASE_BULLET_TIME, "anim_loop_bullet_fire")

ADD_ENUM(WeaponProperty::WEAPON_ANIM2_LOOP_START, "anim2_loop_start")
ADD_ENUM(WeaponProperty::WEAPON_ANIM2_LOOP_STOP, "anim2_loop_stop")
ADD_ENUM(WeaponProperty::WEAPON_ANIM2_LOOP_RELEASE_BULLET_TIME, "anim2_loop_bullet_fire")

ADD_ENUM(WeaponProperty::WEAPON_ANIM_BREAKOUT_TIME, "anim_breakout_time")
...
ADD_ENUM(WeaponProperty::WEAPON_FIRETYPE, "fire_type")

ADD_ENUM(WeaponProperty::WEAPON_MODEL, "model")
ADD_ENUM(WeaponProperty::WEAPON_MODEL2, "model2")

ADD_ENUM(WeaponProperty::WEAPON_SLOT, "weapon_slot")

ADD_ENUM(WeaponProperty::WEAPON_FIRE_OFFSET, "fire_offset")

ADD_ENUM(WeaponProperty::WEAPON_SKILL_LEVEL, "skill_level")
ADD_ENUM(WeaponProperty::WEAPON_REQ_SKILL_LEVEL, "required_skill_level")

ADD_ENUM(WeaponProperty::WEAPON_RADIUS, "radius")

ADD_ENUM(WeaponProperty::WEAPON_AIM_OFFSET, "aim_offset")

ADD_ENUM(WeaponProperty::WEAPON_DEFAULT_COMBO, "default_combo")
ADD_ENUM(WeaponProperty::WEAPON_COMBOS_AVAILABLE, "combos_available")

ADD_ENUM(WeaponProperty::WEAPON_FLAG_AIM_NO_AUTO, "flag_aim_no_auto")
ADD_ENUM(WeaponProperty::WEAPON_FLAG_AIM_ARM, "flag_aim_arm")
ADD_ENUM(WeaponProperty::WEAPON_FLAG_AIM_1ST_PERSON, "flag_aim_1st_person")
ADD_ENUM(WeaponProperty::WEAPON_FLAG_AIM_FREE, "flag_aim_free")
ADD_ENUM(WeaponProperty::WEAPON_FLAG_MOVE_AND_AIM, "flag_move_and_aim")
ADD_ENUM(WeaponProperty::WEAPON_FLAG_MOVE_AND_SHOOT, "flag_move_and_shoot")
ADD_ENUM(WeaponProperty::WEAPON_FLAG_TYPE_THROW, "flag_type_throw")
ADD_ENUM(WeaponProperty::WEAPON_FLAG_TYPE_HEAVY, "flag_type_heavy")
ADD_ENUM(WeaponProperty::WEAPON_FLAG_TYPE_CONSTANT, "flag_type_constant")
ADD_ENUM(WeaponProperty::WEAPON_FLAG_TYPE_DUAL, "flag_type_dual")
ADD_ENUM(WeaponProperty::WEAPON_FLAG_ANIM_RELOAD, "flag_anim_reload")
ADD_ENUM(WeaponProperty::WEAPON_FLAG_ANIM_CROUCH, "flag_anim_crouch")
ADD_ENUM(WeaponProperty::WEAPON_FLAG_ANIM_RELOAD_LOOP, "flag_anim_reload_loop")
ADD_ENUM(WeaponProperty::WEAPON_FLAG_ANIM_RELOAD_LONG, "flag_anim_reload_long")
ADD_ENUM(WeaponProperty::WEAPON_FLAG_SHOT_SLOWS, "flag_shot_slows")
ADD_ENUM(WeaponProperty::WEAPON_FLAG_SHOT_RAND_SPEED, "flag_shot_rand_speed")
ADD_ENUM(WeaponProperty::WEAPON_FLAG_SHOT_ANIM_ABRUPT, "flag_shot_anim_abrupt")
ADD_ENUM(WeaponProperty::WEAPON_FLAG_SHOT_EXPANDS, "flag_shot_expands")

ADD_ENUM(WeaponProperty::WEAPON_FIRE_ROTATION, "fire_rotation")
...
ADD_ENUM(VehicleComponent::VEHICLE_COMPONENT_SPECIAL_3, "special_3")
ADD_ENUM(VehicleComponent::VEHICLE_COMPONENT_SPECIAL_4, "special_4")
ADD_ENUM(VehicleComponent::VEHICLE_COMPONENT_SPECIAL_5, "special_5")
ADD_ENUM(VehicleComponent::VEHICLE_COMPONENT_BONET, "bonnet")
ADD_ENUM(VehicleComponent::VEHICLE_COMPONENT_BOOT, "boot")
ADD_ENUM(VehicleComponent::VEHICLE_COMPONENT_BUMPER_1, "bumper_1")
ADD_ENUM(VehicleComponent::VEHICLE_COMPONENT_BUMPER_2, "bumper_2")
ADD_ENUM(VehicleComponent::VEHICLE_COMPONENT_CHASIS, "chassis")
ADD_ENUM(VehicleComponent::VEHICLE_COMPONENT_DOOR_1, "door_1")
ADD_ENUM(VehicleComponent::VEHICLE_COMPONENT_DOOR_2, "door_2")
ADD_ENUM(VehicleComponent::VEHICLE_COMPONENT_DOOR_3, "door_3")
ADD_ENUM(VehicleComponent::VEHICLE_COMPONENT_DOOR_4, "door_4")
ADD_ENUM(VehicleComponent::VEHICLE_COMPONENT_EXHAUST, "exhaust")
ADD_ENUM(VehicleComponent::VEHICLE_COMPONENT_WINGLF, "wing_lf")
ADD_ENUM(VehicleComponent::VEHICLE_COMPONENT_WINGRF, "wing_rf")
ADD_ENUM(VehicleComponent::VEHICLE_COMPONENT_EXTRA_1, "extra_1")
ADD_ENUM(VehicleComponent::VEHICLE_COMPONENT_EXTRA_2, "extra_2")
IMPLEMENT_ENUM_CLASS_END("vehicle-component")

IMPLEMENT_ENUM_CLASS_BEGIN(ObjectProperty)
ADD_ENUM(ObjectProperty::OBJECT_PROPERTY_ALL, "all")
ADD_ENUM(ObjectProperty::OBJECT_PROPERTY_MASS, "mass")
ADD_ENUM(ObjectProperty::OBJECT_PROPERTY_TURNMASS, "turn_mass")
ADD_ENUM(ObjectProperty::OBJECT_PROPERTY_AIRRESISTANCE, "air_resistance")
ADD_ENUM(ObjectProperty::OBJECT_PROPERTY_ELASTICITY, "elasticity")
ADD_ENUM(ObjectProperty::OBJECT_PROPERTY_CENTEROFMASS, "center_of_mass")
ADD_ENUM(ObjectProperty::OBJECT_PROPERTY_BUOYANCY, "buoyancy")
IMPLEMENT_ENUM_CLASS_END("object-property")

IMPLEMENT_ENUM_CLASS_BEGIN(ObjectGroupPhysicalProperties::Modifiable)
ADD_ENUM(ObjectGroupPhysicalProperties::Modifiable::MASS, "mass")
ADD_ENUM(ObjectGroupPhysicalProperties::Modifiable::TURNMASS, "turn_mass")
ADD_ENUM(ObjectGroupPhysicalProperties::Modifiable::AIRRESISTANCE, "air_resistance")
ADD_ENUM(ObjectGroupPhysicalProperties::Modifiable::ELASTICITY, "elasticity")
ADD_ENUM(ObjectGroupPhysicalProperties::Modifiable::BUOYANCY, "buoyancy")
ADD_ENUM(ObjectGroupPhysicalProperties::Modifiable::UPROOTLIMIT, "uproot_limit")
ADD_ENUM(ObjectGroupPhysicalProperties::Modifiable::COLDAMAGEMULTIPLIER, "col_damage_multiplier")
ADD_ENUM(ObjectGroupPhysicalProperties::Modifiable::COLDAMAGEEFFECT, "col_damage_effect")
ADD_ENUM(ObjectGroupPhysicalProperties::Modifiable::SPECIALCOLRESPONSE, "special_col_response")
ADD_ENUM(ObjectGroupPhysicalProperties::Modifiable::CAMERAAVOID, "avoid_camera")
ADD_ENUM(ObjectGroupPhysicalProperties::Modifiable::EXPLOSION, "cause_explosion")
ADD_ENUM(ObjectGroupPhysicalProperties::Modifiable::FXTYPE, "fx_type")
ADD_ENUM(ObjectGroupPhysicalProperties::Modifiable::FXOFFSET, "fx_offset")
ADD_ENUM(ObjectGroupPhysicalProperties::Modifiable::FXSYSTEM, "fx_system")
ADD_ENUM(ObjectGroupPhysicalProperties::Modifiable::SMASHMULTIPLIER, "smash_multiplier")
ADD_ENUM(ObjectGroupPhysicalProperties::Modifiable::BREAKVELOCITY, "break_velocity")
ADD_ENUM(ObjectGroupPhysicalProperties::Modifiable::BREAKVELOCITYRAND, "break_velocity_randomness")
ADD_ENUM(ObjectGroupPhysicalProperties::Modifiable::BREAKMODE, "break_mode")
ADD_ENUM(ObjectGroupPhysicalProperties::Modifiable::SPARKSONIMPACT, "sparks_on_impact")
IMPLEMENT_ENUM_CLASS_END("objectgroup-modifiable")

IMPLEMENT_ENUM_CLASS_BEGIN(ObjectGroupPhysicalProperties::DamageEffect)
ADD_ENUM(ObjectGroupPhysicalProperties::DamageEffect::NO_EFFECT, "none")
ADD_ENUM(ObjectGroupPhysicalProperties::DamageEffect::CHANGE_MODEL, "change_model")
ADD_ENUM(ObjectGroupPhysicalProperties::DamageEffect::SMASH_COMPLETELY, "smash")
ADD_ENUM(ObjectGroupPhysicalProperties::DamageEffect::CHANGE_THEN_SMASH, "change_smash")
ADD_ENUM(ObjectGroupPhysicalProperties::DamageEffect::BREAKABLE, "breakable")
ADD_ENUM(ObjectGroupPhysicalProperties::DamageEffect::BREAKABLE_REMOVED, "breakable_remove")
IMPLEMENT_ENUM_CLASS_END("objectgroup-damageeffect")

IMPLEMENT_ENUM_CLASS_BEGIN(ObjectGroupPhysicalProperties::CollisionResponse)
ADD_ENUM(ObjectGroupPhysicalProperties::CollisionResponse::NO_RESPONSE, "none")
ADD_ENUM(ObjectGroupPhysicalProperties::CollisionResponse::LAMPPOST, "lamppost")
ADD_ENUM(ObjectGroupPhysicalProperties::CollisionResponse::SMALLBOX, "small_box")
ADD_ENUM(ObjectGroupPhysicalProperties::CollisionResponse::BIGBOX, "big_box")
ADD_ENUM(ObjectGroupPhysicalProperties::CollisionResponse::FENCEPART, "fence_part")
ADD_ENUM(ObjectGroupPhysicalProperties::CollisionResponse::GRENADE, "grenade")
ADD_ENUM(ObjectGroupPhysicalProperties::CollisionResponse::SWINGDOOR, "swingdoor")
ADD_ENUM(ObjectGroupPhysicalProperties::CollisionResponse::LOCKDOOR, "lockdoor")
ADD_ENUM(ObjectGroupPhysicalProperties::CollisionResponse::HANGING, "hanging")
ADD_ENUM(ObjectGroupPhysicalProperties::CollisionResponse::POOLBALL, "poolball")
IMPLEMENT_ENUM_CLASS_END("objectgroup-collisionresponse")

IMPLEMENT_ENUM_CLASS_BEGIN(ObjectGroupPhysicalProperties::FxType)
ADD_ENUM(ObjectGroupPhysicalProperties::FxType::NO_FX, "none")
ADD_ENUM(ObjectGroupPhysicalProperties::FxType::PLAY_ON_HIT, "play_on_hit")
ADD_ENUM(ObjectGroupPhysicalProperties::FxType::PLAY_ON_DESTROYED, "play_on_destroyed")
ADD_ENUM(ObjectGroupPhysicalProperties::FxType::PLAY_ON_HIT_DESTROYED, "play_on_hitdestroyed")
IMPLEMENT_ENUM_CLASS_END("objectgroup-fxtype")

IMPLEMENT_ENUM_CLASS_BEGIN(ObjectGroupPhysicalProperties::BreakMode)
ADD_ENUM(ObjectGroupPhysicalProperties::BreakMode::NOT_BY_GUN, "not_by_gun")
ADD_ENUM(ObjectGroupPhysicalProperties::BreakMode::BY_GUN, "by_gun")
ADD_ENUM(ObjectGroupPhysicalProperties::BreakMode::SMASHABLE, "smashable")
IMPLEMENT_ENUM_CLASS_END("objectgroup-breakmode")
...
IMPLEMENT_ENUM_CLASS_BEGIN(VehicleDummies)
ADD_ENUM(VehicleDummies::LIGHT_FRONT_MAIN, "light_front_main")
ADD_ENUM(VehicleDummies::LIGHT_REAR_MAIN, "light_rear_main")
ADD_ENUM(VehicleDummies::LIGHT_FRONT_SECONDARY, "light_front_second")
ADD_ENUM(VehicleDummies::LIGHT_REAR_SECONDARY, "light_rear_second")
ADD_ENUM(VehicleDummies::SEAT_FRONT, "seat_front")
ADD_ENUM(VehicleDummies::SEAT_REAR, "seat_rear")
ADD_ENUM(VehicleDummies::EXHAUST, "exhaust")
ADD_ENUM(VehicleDummies::ENGINE, "engine")
ADD_ENUM(VehicleDummies::GAS_CAP, "gas_cap")
ADD_ENUM(VehicleDummies::TRAILER_ATTACH, "trailer_attach")
ADD_ENUM(VehicleDummies::HAND_REST, "hand_rest")
ADD_ENUM(VehicleDummies::EXHAUST_SECONDARY, "exhaust_second")
ADD_ENUM(VehicleDummies::WING_AIRTRAIL, "wing_airtrail")
ADD_ENUM(VehicleDummies::VEH_GUN, "veh_gun")
IMPLEMENT_ENUM_CLASS_END("vehicle-dummy")
...
IMPLEMENT_ENUM_CLASS_BEGIN(ResizableVehicleWheelGroup)
ADD_ENUM(ResizableVehicleWheelGroup::FRONT_AXLE, "front_axle")
ADD_ENUM(ResizableVehicleWheelGroup::REAR_AXLE, "rear_axle")
ADD_ENUM(ResizableVehicleWheelGroup::ALL_WHEELS, "all_wheels")
...
// Sound effects
IMPLEMENT_ENUM_CLASS_BEGIN(SoundEffectType)
ADD_ENUM(SoundEffectType::FX_DX8_CHORUS, "chorus")
ADD_ENUM(SoundEffectType::FX_DX8_COMPRESSOR, "compressor")
ADD_ENUM(SoundEffectType::FX_DX8_DISTORTION, "distortion")
ADD_ENUM(SoundEffectType::FX_DX8_ECHO, "echo")
ADD_ENUM(SoundEffectType::FX_DX8_FLANGER, "flanger")
ADD_ENUM(SoundEffectType::FX_DX8_GARGLE, "gargle")
ADD_ENUM(SoundEffectType::FX_DX8_I3DL2REVERB, "i3dl2reverb")
ADD_ENUM(SoundEffectType::FX_DX8_PARAMEQ, "parameq")
ADD_ENUM(SoundEffectType::FX_DX8_REVERB, "reverb")
IMPLEMENT_ENUM_CLASS_END("soundeffect-type")
...
IMPLEMENT_ENUM_CLASS_BEGIN(FxParticleSystems)
ADD_ENUM(FxParticleSystems::PRT_BLOOD, "blood")
ADD_ENUM(FxParticleSystems::PRT_BOATSPLASH, "boat_splash")
ADD_ENUM(FxParticleSystems::PRT_BUBBLE, "bubble")
ADD_ENUM(FxParticleSystems::PRT_DEBRIS, "car_debris")
ADD_ENUM(FxParticleSystems::PRT_SMOKE, "collision_smoke")
ADD_ENUM(FxParticleSystems::PRT_GUNSHELL, "gunshell")
ADD_ENUM(FxParticleSystems::PRT_SAND, "sand")
ADD_ENUM(FxParticleSystems::PRT_SAND2, "sand2")
ADD_ENUM(FxParticleSystems::PRT_SMOKEHUGE, "huge_smoke")
ADD_ENUM(FxParticleSystems::PRT_SMOKE2, "smoke")
ADD_ENUM(FxParticleSystems::PRT_SPARK, "spark")
ADD_ENUM(FxParticleSystems::PRT_SPARK2, "spark2")
ADD_ENUM(FxParticleSystems::PRT_SPLASH, "splash")
ADD_ENUM(FxParticleSystems::PRT_WAKE, "wake")
ADD_ENUM(FxParticleSystems::PRT_WATERSPLASH, "water_splash")
ADD_ENUM(FxParticleSystems::PRT_WHEELDIRT, "wheel_dirt")
ADD_ENUM(FxParticleSystems::PRT_GLASS, "glass")
IMPLEMENT_ENUM_CLASS_END("particle-system")

IMPLEMENT_ENUM_CLASS_BEGIN(WorldProperty)
ADD_ENUM(WorldProperty::AMBIENT_COLOR, "AmbientColor")
ADD_ENUM(WorldProperty::AMBIENT_OBJ_COLOR, "AmbientObjColor")
ADD_ENUM(WorldProperty::DIRECTIONAL_COLOR, "DirectionalColor")
ADD_ENUM(WorldProperty::SPRITE_SIZE, "SpriteSize")
ADD_ENUM(WorldProperty::SPRITE_BRIGHTNESS, "SpriteBrightness")
ADD_ENUM(WorldProperty::POLE_SHADOW_STRENGTH, "PoleShadowStrength")
ADD_ENUM(WorldProperty::SHADOW_STRENGTH, "ShadowStrength")
ADD_ENUM(WorldProperty::SHADOWS_OFFSET, "ShadowsOffset")
ADD_ENUM(WorldProperty::LIGHTS_ON_GROUND, "LightsOnGround")
ADD_ENUM(WorldProperty::LOW_CLOUDS_COLOR, "LowCloudsColor")
ADD_ENUM(WorldProperty::BOTTOM_CLOUDS_COLOR, "BottomCloudsColor")
ADD_ENUM(WorldProperty::CLOUDS_ALPHA1, "CloudsAlpha")
ADD_ENUM(WorldProperty::ILLUMINATION, "Illumination")
ADD_ENUM(WorldProperty::WEATHER_WET_ROADS, "WetRoads")
ADD_ENUM(WorldProperty::WEATHER_FOGGYNESS, "Foggyness")
ADD_ENUM(WorldProperty::WEATHER_FOG, "Fog")
ADD_ENUM(WorldProperty::WEATHER_RAIN_FOG, "RainFog")
ADD_ENUM(WorldProperty::WEATHER_WATER_FOG, "WaterFog")
ADD_ENUM(WorldProperty::WEATHER_SANDSTORM, "Sandstorm")
ADD_ENUM(WorldProperty::WEATHER_RAINBOW, "Rainbow")
...
ADD_ENUM(VehicleAudioSettingProperty::ENGINE_ON_SOUND_BANK_ID, "engine-on-soundbank-id")
ADD_ENUM(VehicleAudioSettingProperty::HORN_HIGH, "horn-high")
ADD_ENUM(VehicleAudioSettingProperty::HORN_TON, "horn-ton")
ADD_ENUM(VehicleAudioSettingProperty::HORN_VOLUME_DELTA, "horn-volume-delta")
ADD_ENUM(VehicleAudioSettingProperty::RADIO_NUM, "radio-num")
ADD_ENUM(VehicleAudioSettingProperty::RADIO_TYPE, "radio-type")
ADD_ENUM(VehicleAudioSettingProperty::SOUND_TYPE, "sound-type")
ADD_ENUM(VehicleAudioSettingProperty::BASS_SETTING, "bass-setting")
ADD_ENUM(VehicleAudioSettingProperty::BASS_EQ, "bass-eq")
ADD_ENUM(VehicleAudioSettingProperty::FIELD_C, "field-c")
...
{
    return (weaponProperty >= WeaponProperty::WEAPON_FLAG_FIRST && weaponProperty <= WeaponProperty::WEAPON_FLAG_LAST);
}
