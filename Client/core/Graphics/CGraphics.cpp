...
CGraphics::CGraphics(CLocalGUI* pGUI)
{
    ...
    m_CurBlendMode = EBlendMode::BLEND;
        ...
        auto line3DPostFX = std::make_unique<CLine3DBatcher>(false);
        ...
        auto materialLinePostFX = std::make_unique<CMaterialLine3DBatcher>(false);
        ...
        auto primitive3DPostFX = std::make_unique<CPrimitive3DBatcher>(false);
        ...
        auto materialPrimitivePostFX = std::make_unique<CMaterialPrimitive3DBatcher>(false, this);
